...
fama <- read.csv("F-F_Research_Data_Factors.CSV") #import factors
mom <- read.csv("F-F_Momentum_Factor.csv") #import momentum factor
...
#Predicted interest will be calculated but not used in the analysis.
